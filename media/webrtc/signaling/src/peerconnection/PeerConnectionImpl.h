...
public:
  ...
  void SetDtlsConnected(bool aPrivacyRequested);
...
private:
  ...
  // This can be false if mPeerIdentity is non-void, in the case where
  // identity is provided, but the media is not protected from the app on
  // either side
